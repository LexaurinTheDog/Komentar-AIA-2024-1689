...
**1. Modelová situace.** Český start-up MedVision s.r.o. (potenciální poskytovatel) vyvíjí vysoce rizikový systém AI pro podporu diagnostiky z rentgenových snímků. V září 2026 je přijat do vnitrostátního regulatorního sandboxu pro AI a s příslušným orgánem sjedná plán sandboxu. Během testování orgán identifikuje riziko zkreslení výstupů u starších pacientů; MedVision podle jeho pokynů zavede zmírňující opatření. Po ukončení účasti požádá o písemné potvrzení o úspěšně provedených činnostech a o závěrečnou zprávu (exit report). Následně orgán dozoru nad trhem zvažuje uložení pokuty za to, že systém v průběhu experimentování dočasně nesplňoval požadavky kapitoly III oddílu 2. Důkazy: schválený plán sandboxu, záznamy komunikace s orgánem, dokumentace zmírňujících opatření, exit report a písemné potvrzení.

**2. Právní otázka.** Může být potenciálnímu poskytovateli, který dodržoval plán sandboxu a v dobré víře se řídil pokyny příslušného orgánu, uložena správní pokuta za porušení nařízení, k němuž došlo při experimentování v sandboxu, a jaké procesní účinky má exit report v posouzení shody?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 57, zejm. odst. 5 (kontrolované prostředí, časové omezení, plán sandboxu), odst. 7 (písemné potvrzení a exit report, jejich kladné zohlednění), odst. 11 (dozorové pravomoci, pozastavení účasti) a odst. 12 (vyloučení správních pokut při dobré víře; trvající odpovědnost za škodu).
- *Související ustanovení téhož nařízení:* čl. 58 (podrobná pravidla a prováděcí akty), čl. 59 (osobní údaje v sandboxu), čl. 43 (posouzení shody), čl. 78 (důvěrnost), čl. 99 (správní pokuty).
- *Související předpisy:* GDPR — při zpracování osobních údajů je dozorový úřad povinně přidružen dle odst. 10; vnitrostátní právo odpovědnosti za škodu (v ČR § 2894 a násl. zákona č. 89/2012 Sb.) pro újmu třetím osobám; vnitrostátní adaptační předpis určující příslušný orgán sandboxu.
- *Judikatura:* k čl. 57 dosud neexistuje (sandboxy mají být funkční od 2. 8. 2026); podpůrně judikatura SDEU k ochraně legitimního očekávání subjektu jednajícího podle pokynů orgánu veřejné moci jako obecné zásadě unijního práva.

**4. Subsumpce.** MedVision je potenciálním poskytovatelem (systém dosud nebyl uveden na trh) a účastní se sandboxu na základě sjednaného plánu — znaky odst. 5 jsou naplněny. Dodržení plánu a dobrá víra při plnění pokynů jsou doloženy záznamy komunikace; sporné by mohlo být jen to, zda dílčí odchylky od plánu byly podstatné. Riziko zkreslení bylo přiměřeně zmírněno, takže nevznikl důvod k pozastavení účasti dle odst. 11. Podmínky podmíněné imunity dle odst. 12 jsou splněny.

**5. Řešení.** Správní pokutu za porušení nařízení nelze uložit (odst. 12); totéž platí pro porušení jiného práva (např. GDPR), pokud byl jeho dozorový orgán aktivně zapojen do dohledu a poskytoval pokyny k souladu. Nedotčena zůstává odpovědnost za škodu způsobenou třetím osobám. Exit report a písemné potvrzení musí orgány dozoru nad trhem a oznámené subjekty zohlednit kladně s cílem přiměřeně urychlit posouzení shody (odst. 7) — nejde však o presumpci shody. Prakticky: o potvrzení žádat písemně, archivovat veškerou komunikaci a dokumentaci plnění pokynů.

**6. Varianty.** (i) Pokud by MedVision podstatně porušil plán sandboxu nebo ignoroval pokyny orgánu, podmíněná imunita odpadá a pokuta dle čl. 99 přichází v úvahu. (ii) Pokud by zjištěné riziko pro zdraví nebylo účinně zmírnitelné, orgán by účast pozastavil či ukončil (odst. 11), informoval Úřad pro AI a případné pokračování testování mimo sandbox by podléhalo plnému sankčnímu režimu.

#### G. Protiargumenty a rizika

- Jazykový výklad odst. 12 věty druhé zmiňuje jen „potenciální poskytovatele" — lze namítat, že poskytovatel s již uvedeným systémem se imunity nedovolá. Neutralizace: věta první hovoří o obou kategoriích a účel ustanovení (snížení rizikové averze inovátorů) svědčí širšímu výkladu; preventivně je vhodné status účastníka vyjasnit přímo v plánu sandboxu.
- „Kladné zohlednění" exit reportu je neurčitý pojem — orgán dozoru jím není vázán a sandboxové dokumenty nenahrazují posouzení shody dle čl. 43. Neutralizace: argumentovat účelem odst. 7 (urychlení postupů) a zásadou řádné správy; výhoda je procesní, nikoli hmotněprávní.
- Slabé místo: do zřízení českého sandboxu a přijetí prováděcích aktů dle čl. 58 chybí konkrétní podmínky účasti i rozhodovací praxe; rozsah pojmu „dobrá víra" bude dotvářen až aplikací.

#### H. Praktický závěr

Účast v sandboxu poskytuje regulatorní dialog, podmíněnou ochranu před správními pokutami a procesně využitelný exit report; nezbavuje však účastníka odpovědnosti za škodu ani povinnosti projít posouzením shody.

**Checklist (poskytovatel / příslušný orgán):**
- [ ] Sjednán a schválen plán sandboxu; vyjasněn status účastníka (poskytovatel vs. potenciální poskytovatel).
- [ ] Průběžně dokumentováno plnění pokynů orgánu (dobrá víra) a zmírňování identifikovaných rizik.
- [ ] Při zpracování osobních údajů ověřeno přidružení dozorového úřadu (odst. 10) — podmínka imunity i pro oblast GDPR.
- [ ] Před ukončením účasti vyžádáno písemné potvrzení a exit report (odst. 7).
- [ ] Exit report uplatněn v posouzení shody / vůči orgánu dozoru nad trhem.

**Typicky rozhodné důkazy / podklady:** plán sandboxu, korespondence s příslušným orgánem, záznamy o zmírňujících opatřeních, exit report, písemné potvrzení o činnostech.
...
**1. Modelová situace.** Brněnský MSP DataMed s.r.o. (potenciální poskytovatel, 40 zaměstnanců) podá žádost o účast v českém regulatorním sandboxu pro AI. Příslušný orgán o žádosti nerozhodne ani po pěti měsících; poté ji bez bližšího odůvodnění odmítne s poukazem na „vyčerpanou kapacitu" a současně požaduje paušální úhradu 150 000 Kč za „administrativní zpracování žádosti". DataMed hodlá výsledky sandboxové účasti využít i při vstupu na německý trh. Důkazy: datovaná žádost, doklady o statusu MSP dle doporučení 2003/361/ES (počet zaměstnanců, obrat), korespondence s orgánem, výzva k úhradě.

**2. Právní otázka.** Je postup orgánu (překročení tříměsíční lhůty, neodůvodněné odmítnutí, paušální poplatek vůči MSP) slučitelný s požadavky čl. 58 odst. 2 a jaké právní účinky má účast v sandboxu jednoho členského státu v ostatních členských státech?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 58 odst. 2 písm. a) (transparentní a spravedlivá kritéria, informování žadatele o rozhodnutí do tří měsíců), písm. b) (široký a rovný přístup), písm. d) (bezplatný přístup pro MSP; výjimečné náklady jen spravedlivě a proporcionálně), písm. g) (vzájemné a jednotné uznávání účasti se stejnými právními účinky v celé Unii).
- *Související ustanovení téhož nařízení:* čl. 57 (zřízení a cíle sandboxu), čl. 62 odst. 1 písm. a) (přednostní přístup MSP), čl. 98 odst. 2 (přezkumný postup pro prováděcí akty), čl. 58 odst. 4 (záruky pro testování v reálných podmínkách v sandboxu).
- *Související předpisy:* prováděcí akty Komise dle čl. 58 odst. 1; doporučení 2003/361/ES (definice MSP); v ČR správní řád č. 500/2004 Sb. (ochrana před nečinností dle § 80) a soudní řád správní (žaloba na nečinnost, žaloba proti rozhodnutí); čl. 41 Listiny základních práv EU (právo na řádnou správu).
- *Judikatura:* specifická k čl. 58 dosud chybí; podpůrně judikatura SDEU k povinnosti odůvodnění aktů veřejné moci a česká správní judikatura k ochraně proti nečinnosti.

**4. Subsumpce.** Status MSP je doložen. Tříměsíční lhůta pro informování žadatele o rozhodnutí byla zjevně překročena. Paušální poplatek 150 000 Kč není „výjimečným nákladem" vybíraným spravedlivě a proporcionálně, nýbrž plošnou platbou v rozporu s písm. d). Neodůvodněné odmítnutí s odkazem na kapacitu koliduje s požadavkem transparentních a spravedlivých kritérií (písm. a)) i s požadavkem, aby sandboxy držely krok s poptávkou (písm. b)). Sporné je, nakolik se lze jednotlivých záruk dovolat před přijetím prováděcích aktů, které je mají „zajistit".

**5. Řešení.** DataMed se brání vnitrostátními prostředky (opatření proti nečinnosti, následně správní žaloba) s argumentací přímo použitelným nařízením a — po jejich přijetí — prováděcími akty; bezplatnost přístupu pro MSP uplatní jako normativní záruku, nikoli dobrodiní orgánu. Odmítnutí musí být přezkoumatelně odůvodněno podle předem stanovených kritérií. Účast v sandboxu jiného členského státu či v sandboxu zřízeném EDPS je dle písm. g) uznávána vzájemně a jednotně se stejnými právními účinky v celé Unii — dokumentaci z českého sandboxu proto DataMed uplatní i v Německu.

**6. Varianty.** (i) Šlo-li by o skutečně výjimečné náklady (např. individuálně vyžádaná nadstandardní testovací infrastruktura) vyúčtované spravedlivě a proporcionálně, jejich úhrada by byla přípustná i u MSP. (ii) Velký podnik (ne-MSP) se bezplatnosti dle písm. d) nedovolá; tříměsíční lhůta, transparentnost kritérií a rovný přístup však svědčí i jemu.

#### G. Protiargumenty a rizika

- Čl. 58 odst. 2 je adresován primárně Komisi (stanoví, co mají prováděcí akty zajistit) — lze namítat, že do jejich přijetí se jednotlivec konkrétních záruk přímo nedovolá. Neutralizace: povinnost funkčního sandboxu od 2. 8. 2026 (čl. 57 odst. 1) a obecné zásady řádné správy platí bez ohledu na prováděcí akty; záruky odst. 2 slouží přinejmenším jako závazné výkladové vodítko.
- „Stejné právní účinky v celé Unii" neznamenají, že orgán jiného členského státu přebírá závěry bez vlastního dozoru — dozorové a nápravné pravomoci zůstávají nedotčeny (čl. 57 odst. 11). Neutralizace: uznání se týká účasti a jejích dokumentů, nikoli náhrady posouzení shody.
- Slabé místo: pojem „výjimečné náklady" není kvantifikován a do vydání prováděcích aktů hrozí rozdílná vnitrostátní praxe — tedy přesně ta fragmentace, jíž má čl. 58 bránit.

#### H. Praktický závěr

Čl. 58 standardizuje přístupová pravidla sandboxů: žadatel má právo být o rozhodnutí informován do tří měsíců na základě transparentních a spravedlivých kritérií, MSP mají přístup bezplatný a účast v kterémkoli unijním sandboxu má jednotné právní účinky v celé Unii.

**Checklist (žadatel / příslušný orgán):**
- [ ] Doložen status MSP/start-upu dle doporučení 2003/361/ES (nárok na bezplatný přístup).
- [ ] Žádost datována; hlídána tříměsíční lhůta pro informování o rozhodnutí.
- [ ] Vyžádána výběrová kritéria a přezkoumatelné odůvodnění případného odmítnutí.
- [ ] U požadovaných plateb ověřeno, že jde o výjimečné, spravedlivě a proporcionálně vyúčtované náklady.
- [ ] Při zamýšleném testování v reálných podmínkách uvnitř sandboxu sjednány zvláštní záruky dle odst. 4.

**Typicky rozhodné důkazy / podklady:** datovaná žádost s přílohami, doklady o velikosti podniku, zveřejněná kritéria výběru, rozhodnutí orgánu s odůvodněním, vyúčtování nákladů.
...
**1. Modelová situace.** Fakultní nemocnice (správce) disponuje databází CT snímků shromážděných při poskytování zdravotní péče. Univerzitní spin-off MedAI s.r.o. (potenciální poskytovatel) chce v regulatorním sandboxu trénovat a testovat vysoce rizikový systém AI pro včasnou detekci plicních nádorů. Anonymizace by data znehodnotila (nutná korelace snímků s dalším vývojem onemocnění) a syntetická data nepostačují k naplnění požadavků čl. 10 na reprezentativnost. MedAI zřídí funkčně oddělené, izolované prostředí s řízeným přístupem, mechanismy monitoringu rizik a plánem výmazu; shrnutí projektu je zveřejněno na webu příslušného orgánu; Úřad pro ochranu osobních údajů je k sandboxu přidružen dle čl. 57 odst. 10. Důkazy: doklad zákonnosti původního sběru, odborné odůvodnění nezbytnosti reálných dat, posouzení vlivu (DPIA), technický popis prostředí, přístupové logy, smlouva nemocnice–MedAI.

**2. Právní otázka.** Lze CT snímky pacientů (zvláštní kategorie osobních údajů) zákonně dále zpracovat — bez souhlasu pacientů — pro vývoj, trénování a testování systému AI v sandboxu?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 59 odst. 1 — odchylka od zásady omezení účelu při kumulativním splnění podmínek písm. a) až j); zde písm. a) bod i) (veřejné zdraví, detekce a diagnostika nemocí).
- *Související ustanovení téhož nařízení:* čl. 57 odst. 10 (povinné přidružení dozorového úřadu), kapitola III oddíl 2, zejm. čl. 10 (měřítko „nezbytnosti" dle písm. b)), příloha IV (technická dokumentace dle písm. i)).
- *Související předpisy:* GDPR — čl. 5 odst. 1 písm. b) (omezení účelu), čl. 6 odst. 4 (test slučitelnosti, vůči němuž je čl. 59 lex specialis), čl. 6 odst. 1 a čl. 9 odst. 2 (právní základ a výjimka pro zvláštní kategorie), čl. 35 (DPIA, na nějž odkazuje písm. c)); směrnice (EU) 2016/680 pro trestněprávní oblast (odst. 2); zákon č. 110/2019 Sb.; zákon č. 372/2011 Sb., o zdravotních službách (mlčenlivost, zdravotnická dokumentace).
- *Judikatura:* ustálená judikatura SDEU k zásadě omezení účelu a restriktivnímu výkladu výjimek z ochrany osobních údajů (požadavek nezbytnosti a proporcionality); rozhodovací praxe ÚOOÚ k anonymizaci zdravotních dat.

**4. Subsumpce.** Oblast písm. a) bodu i) je naplněna (detekce a diagnostika nemocí); vývoj „jinou právnickou osobou" písm. a) výslovně připouští. Klíčová a potenciálně sporná je podmínka písm. b): nezbytnost osobních údajů pro splnění požadavků kapitoly III oddílu 2 musí být odborně doložena — pouhá nákladnost anonymizace nepostačí. Podmínky písm. c) až j) (monitoring vysokých rizik, izolované prostředí, zákaz sdílení údajů vytvořených v sandboxu, zákaz účinků vůči subjektům údajů, technická a organizační opatření s výmazem, logy, dokumentace, zveřejnění shrnutí) jsou zajištěny technicko-organizačně a musí být průběžně dokladovány. Současně musí existovat právní základ dle čl. 6 odst. 1 GDPR a výjimka dle čl. 9 odst. 2 GDPR — čl. 59 sám řeší pouze slučitelnost účelu.

**5. Řešení.** Další zpracování je přípustné při kumulativním splnění všech podmínek odst. 1; souhlas pacientů se nevyžaduje, je-li dán jiný právní základ (zpravidla čl. 6 odst. 1 písm. e) GDPR — úkol ve veřejném zájmu) a výjimka dle čl. 9 odst. 2 GDPR (typicky písm. i) či j)). Postup: DPIA, konzultace s přidruženým ÚOOÚ v rámci sandboxu, smluvní vymezení rolí nemocnice a MedAI (sdílení původních dat jen v souladu s právem ochrany údajů dle písm. e)), technické oddělení prostředí, plán výmazu po skončení účasti, zveřejnění shrnutí projektu. Výstupy nesmí vyvolat žádná opatření či rozhodnutí vůči konkrétním pacientům (písm. f)).

**6. Varianty.** (i) Vývoj komerční wellness aplikace bez podstatného veřejného zájmu → podmínka písm. a) není splněna a odchylka je nepoužitelná. (ii) Lze-li požadavky čl. 10 účinně splnit syntetickými či anonymizovanými daty, padá podmínka písm. b) a další zpracování osobních údajů je nepřípustné.

#### G. Protiargumenty a rizika

- Nejsilnější námitka: čl. 59 nederoguje GDPR — neposkytuje právní základ dle čl. 6 ani výjimku dle čl. 9 GDPR; bez nich je zpracování nezákonné i při splnění všech sandboxových podmínek. Neutralizace: dvouvrstvá analýza (právní základ + slučitelnost účelu dle čl. 59) provedená v DPIA a konzultovaná s dozorovým úřadem přidruženým dle čl. 57 odst. 10.
- Riziko memorizace osobních údajů v natrénovaném modelu: písm. e) zakazuje sdílet mimo sandbox údaje v sandboxu vytvořené — export modelu, z něhož lze tréninková data rekonstruovat, by tento zákaz obcházel. Neutralizace: testy memorizace a techniky ochrany soukromí (např. diferenciální soukromí) před vynesením modelu ze sandboxu.
- Napětí mezi povinností výmazu (písm. g)) a povinností uchovat úplnou dokumentaci trénování (písm. i)): řešit oddělením — popis procesu bez osobních údajů zůstává součástí dokumentace dle přílohy IV, samotná data se mažou. Slabé místo: nařízení nedává vodítko k přípustné délce doby uchovávání.

#### H. Praktický závěr

Čl. 59 umožňuje v sandboxu legálně využít existující reálná data pro vývoj AI v taxativně vymezených oblastech veřejného zájmu, avšak jen jako úzkou, kumulativně podmíněnou odchylku od zásady omezení účelu — nikoli jako samostatný právní základ zpracování.

**Checklist (potenciální poskytovatel / správce dat / dozorový úřad):**
- [ ] Projekt spadá do některé z oblastí odst. 1 písm. a) bodů i)–v) a sleduje podstatný veřejný zájem.
- [ ] Odborně doložena nezbytnost osobních údajů (proč nepostačí anonymizovaná/syntetická data) ve vztahu ke kapitole III oddílu 2.
- [ ] Identifikován právní základ dle čl. 6 GDPR a u zvláštních kategorií výjimka dle čl. 9 odst. 2 GDPR; zpracována DPIA.
- [ ] Zajištěno izolované prostředí, řízení přístupů, logy, monitoring rizik a mechanismus zastavení zpracování.
- [ ] Nastaven výmaz dat po skončení účasti, zákaz sdílení údajů vytvořených v sandboxu a zveřejněno shrnutí projektu.

**Typicky rozhodné důkazy / podklady:** DPIA, odborné odůvodnění nezbytnosti reálných dat, technická dokumentace prostředí a přístupů, logy zpracování, smlouvy o rolích správce/zpracovatele, doklad o zveřejnění shrnutí projektu.
...
**1. Modelová situace.** RecruitTech a.s. (potenciální poskytovatel) vyvinula systém AI pro třídění uchazečů o zaměstnání (vysoce rizikový systém dle přílohy III bodu 4) a před uvedením na trh jej chce testovat v reálných podmínkách u partnerského zaměstnavatele (potenciální zavádějící subjekt) při skutečných náborech. Sestaví plán testování v reálných podmínkách a předloží jej orgánu dozoru nad trhem; ten nereaguje 35 dnů. Mezi uchazeči jsou i osoby se zdravotním postižením; o postupu uchazečů rozhodují personalisté, kteří mohou výstupy systému přehlasovat. Po dvou měsících jeden subjekt testování odvolá souhlas; po čtyřech měsících je zjištěno, že systém systematicky znevýhodňoval určitou skupinu uchazečů (závažný incident). Důkazy: plán testování s dokladem o datu předložení, registrace v databázi EU, dohoda se zavádějícím subjektem, informované souhlasy, záznamy o lidském dohledu a přehlasování výstupů.

**2. Právní otázka.** Za jakých kumulativních podmínek smí RecruitTech testovat systém v reálných podmínkách mimo sandbox a jaké povinnosti jí vznikají při odvolání souhlasu subjektu a při závažném incidentu?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 60 odst. 4 písm. a)–k) (plán testování, schválení orgánem dozoru včetně 30denní fikce, registrace, usazení v Unii, šestiměsíční limit s možností prodloužení, ochrana zranitelných skupin, dohoda se zavádějícím subjektem, informovaný souhlas, účinný dohled, zvratitelnost výstupů), odst. 5 (odvolání souhlasu), odst. 7–8 (závažné incidenty, oznámení ukončení), odst. 9 (plná odpovědnost za škodu).
- *Související ustanovení téhož nařízení:* čl. 61 (náležitosti souhlasu), čl. 5 (zákazy nedotčeny), čl. 13 (pokyny k použití), čl. 71 odst. 4 a příloha IX (registrace), čl. 73 (hlášení závažných incidentů), čl. 75 (pravomoci orgánů dozoru).
- *Související předpisy:* GDPR (zpracování údajů uchazečů; čl. 22 k automatizovanému rozhodování); antidiskriminační zákon č. 198/2009 Sb.; zákoník práce; u produktů dle přílohy I sektorové harmonizační předpisy (odst. 1 pododst. 3); inspiračně nařízení (EU) č. 536/2014 o klinickém hodnocení.
- *Judikatura:* k čl. 60 dosud chybí; nosný je rozsudek SDEU ve věci SCHUFA (scoring jako automatizované rozhodnutí dle čl. 22 GDPR) pro posouzení reálné váhy lidského přehlasování výstupů.

**4. Subsumpce.** Plán byl předložen (písm. a)). Marným uplynutím 30 dnů nastala fikce schválení (písm. b)) — ledaže by vnitrostátní právo fikci vylučovalo; to je nutno ověřit v adaptačním předpisu. Systém dle bodu 4 přílohy III nepatří mezi výjimky (body 1, 2, 6 a 7), registruje se tedy standardně dle čl. 71 odst. 4 s jedinečným identifikačním číslem (písm. c)). Poskytovatel je usazen v Unii (písm. d)), testování trvá čtyři měsíce (písm. f)). U uchazečů se zdravotním postižením je třeba doložit zvláštní ochranu (písm. g)). Dohoda o rolích se zaměstnavatelem (písm. h)), souhlasy dle čl. 61 (písm. i)), kvalifikovaný dohled (písm. j)) i zvratitelnost výstupů díky rozhodování personalistů (písm. k)) jsou splněny.

**5. Řešení.** Testování je přípustné jen při současném splnění všech podmínek odst. 4. Odvolání souhlasu: subjekt musí být bez jakékoli újmy a bez udání důvodů vyřazen a na žádost se jeho osobní údaje okamžitě a trvale vymažou; již provedené činnosti zůstávají nedotčeny (odst. 5). Závažný incident (systematické znevýhodnění): hlášení orgánu dozoru nad trhem dle čl. 73, okamžitá zmírňující opatření, jinak pozastavení či ukončení testování a aktivace postupu okamžitého stažení systému (odst. 7); pozastavení/ukončení a konečné výsledky se oznamují orgánu (odst. 8). Za škodu způsobenou uchazečům odpovídá poskytovatel plně (odst. 9) — na rozdíl od sandboxu zde není žádná ochrana před správními pokutami.

**6. Varianty.** (i) Šlo-li by o systém v oblasti prosazování práva (bod 1 přílohy III), registrace by proběhla v bezpečné neveřejné části databáze EU a výjimka ze souhlasu (písm. i)) by byla použitelná jen při nulovém negativním dopadu na subjekty a výmazu jejich údajů po testu. (ii) Kdyby výstupy systému automaticky vyřazovaly uchazeče bez možnosti zvrácení, podmínka písm. k) by nebyla splněna a testování by bylo od počátku nezákonné.

#### G. Protiargumenty a rizika

- Fikce schválení po 30 dnech nezaručuje věcný přezkum plánu a vnitrostátní právo ji může vyloučit; spoléhání na fikci je rizikové. Neutralizace: vyžádat výslovné schválení, počátek lhůty dokládat doručenkou a před zahájením testování ověřit vnitrostátní úpravu.
- Souhlas s účastí na testování dle čl. 61 není automaticky právním základem zpracování osobních údajů dle čl. 6 GDPR — dvojkolejnost režimů může vést k nezákonnosti zpracování i při platném „testovacím" souhlasu. Neutralizace: oddělené posouzení obou titulů v dokumentaci.
- Hranice mezi testováním a faktickým uvedením do provozu: ovlivňují-li výstupy reálně náborová rozhodnutí, hrozí kvalifikace, že systém je již provozován bez posouzení shody. Slabé místo — nutno důsledně dokumentovat, že rozhodují lidé a výstupy lze účinně zvrátit a ignorovat (písm. k)).

#### H. Praktický závěr

Testování mimo sandbox je flexibilní, ale plně rizikový režim: kumulativní podmínky odst. 4, časový limit šesti (po prodloužení nejvýše dvanácti) měsíců, registrační a oznamovací povinnosti a plná odpovědnost poskytovatele bez sandboxové imunity.

**Checklist (poskytovatel / zavádějící subjekt / orgán dozoru nad trhem):**
- [ ] Plán testování zpracován dle prováděcího aktu Komise a předložen orgánu dozoru; doloženo schválení nebo fikce schválení.
- [ ] Provedena registrace testování s jedinečným identifikačním číslem ve správném režimu dle typu systému.
- [ ] Uzavřena dohoda o rolích a odpovědnosti se zavádějícím subjektem; předány pokyny k použití dle čl. 13.
- [ ] Získány informované souhlasy dle čl. 61; nastaven proces odvolání souhlasu a výmazu údajů.
- [ ] Zajištěn kvalifikovaný dohled, zvratitelnost výstupů, ochrana zranitelných skupin a postup hlášení incidentů dle čl. 73.

**Typicky rozhodné důkazy / podklady:** plán testování a doklad o předložení, registrační záznam v databázi EU, dohoda se zavádějícím subjektem, souhlasové formuláře, záznamy lidského dohledu a přehlasování výstupů, hlášení incidentů.
...
**1. Modelová situace.** Fintech LoanAI s.r.o. (potenciální poskytovatel) testuje spolu s bankou (potenciální zavádějící subjekt) v reálných podmínkách systém AI pro hodnocení úvěruschopnosti spotřebitelů. Klientům je na pobočce předkládán dvanáctistránkový formulář „souhlasu s inovativním zpracováním", který neuvádí jedinečné identifikační číslo testování ani poučení o možnosti žádat zvrácení či ignorování výstupů systému; kopie dokumentu se klientům nepředává a podpis je fakticky podmínkou dalšího zpracování žádosti o úvěr. Klient X podepíše a později namítá neplatnost souhlasu. Důkazy: text formuláře, interní instrukce pobočky, výpověď klienta, absence záznamu o předání kopie a o dataci souhlasu.

**2. Právní otázka.** Splňuje takto získaný souhlas náležitosti svobodně uděleného, informovaného a dokumentovaného souhlasu dle čl. 61 a jaké důsledky má jeho vadnost pro zákonnost testování dle čl. 60?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 61 odst. 1 písm. a)–e) (taxativní okruh informací: povaha a cíle testování a možné nepříjemnosti, podmínky a očekávaná délka účasti, práva a záruky včetně práva odmítnout účast a kdykoli bez újmy odstoupit, opatření pro vyžádání zrušení/ignorování výstupů, identifikační číslo testování a kontaktní údaje) a odst. 2 (datace, dokumentace, předání kopie subjektu).
- *Související ustanovení téhož nařízení:* čl. 60 odst. 4 písm. i) (souhlas jako kumulativní podmínka zákonnosti testování) a odst. 5 (odvolání souhlasu), čl. 99 (správní pokuty).
- *Související předpisy:* GDPR — čl. 4 bod 11 a čl. 7 (svobodnost souhlasu, zákaz podmiňování plnění souhlasem, důkazní břemeno správce), čl. 12 (srozumitelnost informací); nařízení (EU) č. 536/2014 jako inspirační vzor informovaného souhlasu; § 1812 zákona č. 89/2012 Sb. (výklad ve prospěch slabší strany).
- *Judikatura:* SDEU ve věcech Planet49 (C-673/17) a Orange România (C-61/19) — souhlas musí být aktivní, konkrétně informovaný a správcem prokazatelný; nosné závěry jsou analogicky použitelné na souhlas dle čl. 61.

**4. Subsumpce.** Dvanáctistránkový právnický text odporuje požadavku „stručných, jasných, relevantních a srozumitelných" informací. Chybí obligatorní náležitosti dle písm. d) a e) — poučení o možnosti žádat zvrácení výstupů a identifikační číslo testování s kontakty. Faktické podmínění zpracování úvěrové žádosti podpisem vylučuje svobodnost souhlasu. Nepředání kopie a absence datace porušují odst. 2. Souhlas tedy nesplňuje hned několik kumulativních náležitostí.

**5. Řešení.** Souhlas je vadný, tudíž není splněna podmínka čl. 60 odst. 4 písm. i) a testování je vůči dotčeným subjektům nezákonné. Náprava: přepracovat formulář (stručné, vrstvené informace pokrývající všechny body písm. a)–e)), oddělit účast na testování od vyřízení úvěru, zavést evidenci datovaných souhlasů a prokazatelné předávání kopií. Orgán dozoru nad trhem může uplatnit kontrolní pravomoci dle čl. 60 odst. 6 a sankce dle čl. 99; vadné souhlasy nelze zhojit zpětně — musí být získány znovu.

**6. Varianty.** (i) Pokud by účast na testování byla zcela oddělena od úvěrového procesu (úvěr posouzen standardně i bez účasti) a formulář obsahoval všechny náležitosti ve srozumitelné podobě s předáním kopie, souhlas by obstál. (ii) Probíhalo-li by testování pod dohledem uvnitř sandboxu, čl. 61 se formálně nepoužije (platí pro testování „mimo sandboxy"); obdobné záruky by však sjednal příslušný orgán v podmínkách testování dle čl. 58 odst. 4.

#### G. Protiargumenty a rizika

- Námitka, že čl. 61 nevyžaduje výslovně písemnou formu, takže postačí ústní souhlas: neobstojí plně — odst. 2 vyžaduje dataci, dokumentaci a předání kopie, což trvalý nosič fakticky předpokládá. Neutralizace: vést standardizovaný, datovaný a archivovaný záznam.
- Argument, že vady souhlasu jsou jen formální a subjektům věcně neškodí: souhlas je konstitutivní podmínkou zákonnosti testování (čl. 60 odst. 4 písm. i)), nikoli formalitou; absence taxativních náležitostí činí účast subjektu protiprávní bez ohledu na následky.
- Slabé místo: vztah souhlasu dle čl. 61 a právního základu zpracování dle GDPR není v nařízení výslovně vyřešen — jediný dokument může pokrýt oba režimy, ale směšování účelů ohrožuje granularitu souhlasu dle GDPR; do vydání standardizovaných šablon Úřadu pro AI (srov. čl. 62 odst. 3 písm. a)) je vhodná konzervativní praxe oddělených vrstev.

#### H. Praktický závěr

Informovaný souhlas dle čl. 61 je samostatná, taxativně strukturovaná podmínka zákonnosti testování v reálných podmínkách; jeho vady kontaminují celé testování vůči dotčeným subjektům a nelze je zhojit zpětně.

**Checklist (poskytovatel / zavádějící subjekt):**
- [ ] Informace stručné, jasné, relevantní a srozumitelné; pokryty všechny body odst. 1 písm. a)–e) včetně ID testování a kontaktů.
- [ ] Poučení o právu odmítnout účast a kdykoli bez újmy a bez udání důvodů odstoupit.
- [ ] Popsán konkrétní mechanismus, jak žádat zrušení/ignorování výstupů systému AI.
- [ ] Souhlas datován, zdokumentován a kopie prokazatelně předána subjektu či zákonnému zástupci.
- [ ] Účast na testování není podmínkou přístupu k jiné službě; odděleny právní základy dle GDPR.

**Typicky rozhodné důkazy / podklady:** souhlasový formulář, záznam o předání kopie, evidence souhlasů a jejich odvolání, interní instrukce k získávání souhlasů, registrační číslo testování.
...
**1. Modelová situace.** Start-up RoboSafe s.r.o. (15 zaměstnanců, sídlo v Ostravě) vyvíjí vysoce rizikový systém AI — bezpečnostní komponentu strojního zařízení. Uchází se o účast v českém sandboxu, kde o kapacitu soutěží mj. s dceřinou společností nadnárodní skupiny; oznámený subjekt mu za posouzení shody dle čl. 43 nabízí stejný ceník jako velkým korporacím; stát nepořádá žádná školení k nařízení a neexistuje komunikační kanál pro dotazy MSP. RoboSafe se dovolává čl. 62. Důkazy: doklady o statusu MSP (počet zaměstnanců, obrat, vlastnická struktura dle doporučení 2003/361/ES), žádost o účast v sandboxu, ceník a korespondence s oznámeným subjektem.

**2. Právní otázka.** Jaká konkrétní oprávnění může MSP se sídlem v Unii dovodit z čl. 62 — zejména přednostní přístup do sandboxu a proporcionální snížení poplatků za posouzení shody — a vůči komu je uplatní?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 62 odst. 1 písm. a) (přednostní přístup MSP/start-upů se sídlem nebo pobočkou v Unii do sandboxů), písm. b)–d) (osvěta a školení, komunikační kanály, účast na normalizaci), odst. 2 (proporcionální snížení poplatků za posouzení shody dle čl. 43), odst. 3 (úkoly Úřadu pro AI: šablony, jednotná informační platforma, kampaně, veřejné zakázky).
- *Související ustanovení téhož nařízení:* čl. 58 odst. 2 písm. a), b) a d) (transparentní kritéria, rovný a pro MSP bezplatný přístup do sandboxu), čl. 43 (posouzení shody), čl. 57 odst. 17 (jednotné rozhraní), čl. 99 odst. 6 (nižší stropy pokut pro MSP).
- *Související předpisy:* doporučení Komise 2003/361/ES (definice MSP a start-upu z hlediska velikosti); ustanovení nařízení o oznámených subjektech a dohledu nad nimi (kapitola III oddíl 4).
- *Judikatura:* specifická chybí; podpůrně unijní judikatura k restriktivnímu pojetí statusu MSP (vyloučení podniků fakticky ovládaných skupinou) a k zásadám rovného zacházení a proporcionality.

**4. Subsumpce.** RoboSafe splňuje definici MSP a má sídlo v Unii — náleží mu přednostní přístup do sandboxu, splní-li podmínky způsobilosti a výběrová kritéria; přednost není absolutní (nevylučuje jiné žadatele splňující kritéria), ale při omezené kapacitě působí jako rozhodovací kritérium ve prospěch MSP. Jednotný ceník oznámeného subjektu nezohledňující velikost, velikost trhu a další ukazatele odporuje odst. 2, který ukládá proporcionální snížení poplatků. Absence školení a komunikačních kanálů znamená nesplnění povinností členského státu dle odst. 1 písm. b) a c) — ta však zakládají primárně objektivní povinnost státu, nikoli individuální nárok jednotlivce.

**5. Řešení.** RoboSafe v žádosti o sandbox výslovně uplatní a doloží status MSP (priorita dle odst. 1 písm. a) plus bezplatnost dle čl. 58 odst. 2 písm. d)). Vůči oznámenému subjektu se dovolá odst. 2 a vyjedná sníženou sazbu; při odmítnutí podá podnět vnitrostátnímu oznamujícímu orgánu vykonávajícímu dohled nad oznámenými subjekty. Systémové nesplnění povinností státu lze namítnout stížností Komisi (možné řízení o porušení povinnosti); individuálně nejlépe vymahatelné jsou přednostní přístup a poplatkové zvýhodnění, neboť jsou formulovány bezpodmínečně.

**6. Varianty.** (i) Při růstu nad prahy MSP výhody čl. 62 odpadají; zůstává rovný přístup do sandboxu dle čl. 58. (ii) Mikropodnik do 10 zaměstnanců bez partnerských a propojených podniků navíc získá zjednodušený režim systému řízení kvality dle čl. 63.

#### G. Protiargumenty a rizika

- Námitka „programové povahy" čl. 62: většina povinností je adresována státům a Úřadu pro AI a jednotlivec se jich přímo nedovolá. Neutralizace: odst. 1 písm. a) a odst. 2 jsou formulovány bezpodmínečně a dostatečně určitě pro přímou aplikaci; zbytek představuje objektivní povinnosti vymahatelné systémově (dozor Komise).
- Přednostní přístup MSP může kolidovat s požadavkem širokého a rovného přístupu dle čl. 58 odst. 2 písm. b): velcí žadatelé mohou namítat diskriminaci. Neutralizace: jde o nařízením výslovně předvídané zvýhodnění v mezích transparentních kritérií, nikoli o svévoli; ostatní MSP nadto nesmí být prioritou vyloučeny.
- Slabé místo: míra „proporcionálního" snížení poplatků není kvantifikována — prostor pro spory s oznámenými subjekty; skrytá propojenost žadatele se skupinou může status MSP zpochybnit, proto je nutná pečlivá dokumentace vlastnické struktury.

#### H. Praktický závěr

Čl. 62 přetavuje politiku podpory MSP do tří prakticky uplatnitelných výhod: přednostní (a dle čl. 58 bezplatný) přístup do sandboxu, proporcionálně snížené poplatky za posouzení shody a centralizovaná informační podpora státu a Úřadu pro AI.

**Checklist (MSP/start-up / členský stát / Úřad pro AI):**
- [ ] Ověřen a zdokumentován status MSP dle doporučení 2003/361/ES (zaměstnanci, obrat, propojenost).
- [ ] V žádosti o sandbox výslovně uplatněna priorita dle čl. 62 odst. 1 písm. a) a bezplatnost dle čl. 58.
- [ ] U oznámeného subjektu vyžádáno proporcionální snížení poplatku dle odst. 2; nesouhlas eskalován oznamujícímu orgánu.
- [ ] Využity standardizované šablony a jednotná informační platforma Úřadu pro AI (odst. 3).
- [ ] Sledovány osvětové akce, školení a komunikační kanály členského státu (odst. 1 písm. b) a c)).

**Typicky rozhodné důkazy / podklady:** účetní výkazy a vlastnická struktura (status MSP), žádost o sandbox s doklady, ceník a korespondence s oznámeným subjektem, ukazatele velikosti trhu.
...
**1. Modelová situace.** VisionTech s.r.o. má 6 zaměstnanců a roční obrat 1,5 mil. EUR; vyvíjí vysoce rizikový systém AI pro vyhodnocování kamerových záznamů. Jediným společníkem je však softwarová skupina s 800 zaměstnanci. VisionTech s odkazem na čl. 63 odst. 1 zavede „odlehčený" systém řízení kvality dle čl. 17 a současně přestane vést technickou dokumentaci dle čl. 11 s argumentem, že „na mikropodniky se požadavky vztahují zjednodušeně". Orgán dozoru nad trhem zahájí kontrolu. Důkazy: výkazy o počtu zaměstnanců a obratu, výpis z obchodního rejstříku a vlastnická struktura (propojenost), interní dokumentace QMS, stav technické dokumentace.

**2. Právní otázka.** Může se VisionTech dovolat zjednodušeného plnění prvků systému řízení kvality dle čl. 63 odst. 1, a pokud ano, v jakém věcném rozsahu?

**3. Použitelné právo.**
- *Komentované ustanovení:* čl. 63 odst. 1 (zjednodušené plnění určitých prvků QMS pro mikropodniky bez partnerských a propojených podniků; konkretizace pokyny Komise) a odst. 2 (zákaz výkladu jako osvobození od ostatních povinností, zejm. čl. 9–15, 72 a 73).
- *Související ustanovení téhož nařízení:* čl. 17 (systém řízení kvality — jediný předmět odchylky), čl. 11 a příloha IV (technická dokumentace — odchylkou výslovně nedotčena), čl. 99 odst. 6 (zohlednění velikosti podniku při ukládání pokut).
- *Související předpisy:* doporučení Komise 2003/361/ES — definice mikropodniku (méně než 10 zaměstnanců a roční obrat nebo bilanční suma do 2 mil. EUR) a pojmy partnerského a propojeného podniku; pokyny Komise k zjednodušenému plnění prvků QMS (po jejich vydání).
- *Judikatura:* unijní judikatura k definici MSP zdůrazňující posuzování celé hospodářské jednotky — podniky ovládané skupinou se nepovažují za samostatné mikropodniky (restriktivní výklad zvýhodnění).

**4. Subsumpce.** Početně i obratem VisionTech prahy mikropodniku splňuje. Stoprocentní ovládání skupinou z ní však činí propojený podnik ve smyslu doporučení 2003/361/ES, čímž padá negativní podmínka čl. 63 odst. 1 — odchylka je pro ni nedostupná. I při jejím splnění by se zjednodušení týkalo výhradně určitých prvků QMS dle čl. 17 v rozsahu vymezeném pokyny Komise; upuštění od technické dokumentace dle čl. 11 je vyloučeno odst. 2, který výčtem (čl. 9–15, 72, 73) blokuje jakýkoli rozšiřující výklad odchylky.

**5. Řešení.** VisionTech musí plnit QMS v plném rozsahu a neprodleně obnovit vedení technické dokumentace; její absence je porušením sankcionovatelným dle čl. 99 a orgán dozoru uloží nápravné opatření. Skutečný samostatný mikropodnik by mohl zjednodušit pouze ty prvky QMS, které vymezí pokyny Komise; do jejich vydání je obezřetné plnit čl. 17 standardně a zjednodušení nasadit až podle obsahu pokynů, protože čl. 63 sám rozsah zjednodušení nestanoví.

**6. Varianty.** (i) Kdyby VisionTech neměla žádné partnerské či propojené podniky, odchylka by byla použitelná — avšak stále jen na prvky QMS vymezené pokyny Komise, při zachované úrovni ochrany. (ii) Při překročení prahů mikropodniku (10 a více zaměstnanců nebo obrat/bilanční suma nad 2 mil. EUR) v rozhodném období status zaniká a s ním i nárok na zjednodušení.

#### G. Protiargumenty a rizika

- Argument, že do vydání pokynů Komise si mikropodnik smí rozsah zjednodušení určit sám úvahou o přiměřenosti: riskantní — čl. 63 odst. 1 váže zjednodušení na pokyny („za tímto účelem Komise vypracuje pokyny") a bez nich neexistuje bezpečný přístav; svévolné zjednodušení může orgán dozoru kvalifikovat jako nesplnění čl. 17.
- Námitka, že výčet v odst. 2 je uvozen slovem „včetně", a je tedy demonstrativní — to ovšem pozici mikropodniku oslabuje, nikoli posiluje: nedotčeny zůstávají všechny ostatní povinnosti nařízení a odchylka se týká výhradně čl. 17.
- Slabé místo: hraniční případy partnerských podniků (podíly 25–50 %) a kolísání počtu zaměstnanců či obratu činí status mikropodniku nejistým; chybná sebekvalifikace vede ke zpětnému odpadnutí odchylky a riziku sankcí.

#### H. Praktický závěr

Čl. 63 je úzká administrativní úleva: samostatným mikropodnikům umožňuje zjednodušeně plnit vybrané prvky QMS dle čl. 17, avšak nemění žádný věcný požadavek na vysoce rizikové systémy AI ani úroveň ochrany.

**Checklist (mikropodnik / orgán dozoru nad trhem):**
- [ ] Ověřeny prahy mikropodniku (zaměstnanci, obrat/bilanční suma) dle doporučení 2003/361/ES.
- [ ] Vyloučena existence partnerských a propojených podniků (analýza vlastnické struktury).
- [ ] Identifikovány prvky QMS, které pokyny Komise připouštějí plnit zjednodušeně; zbytek čl. 17 plněn standardně.
- [ ] Potvrzeno plné plnění čl. 9–15 (řízení rizik, data, dokumentace, záznamy, transparentnost, lidský dohled, přesnost a kybernetická bezpečnost) a čl. 72–73.
- [ ] Nastaveno průběžné sledování statusu (růst, akvizice, změny struktury) a vydání pokynů Komise.

**Typicky rozhodné důkazy / podklady:** účetní závěrky, evidence zaměstnanců, výpis z obchodního rejstříku a struktura skupiny, dokumentace QMS, technická dokumentace dle přílohy IV.
